...
namespace MacroCalc.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public RegisterModel(
            ...
            IMacroEntriesService macroEntriesService,
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // new user gets new macro entry with default zeros
                    await _macroEntriesService.AddMacroEntry(userId);
